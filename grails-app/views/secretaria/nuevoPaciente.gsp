        ...
        <h1>Nuevo paciente </h1>
	        ...
	        <div class="panel panel-pt-primary">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
						<label for="">Fecha de nacimiento </label> <input required="" type="text" class="form-control" placeholder="dd/mm/aaaa" onfocus="(this.type='date')" id="fechaDeNacimiento" max="${today.format('yyyy-MM-dd')}"/><br/>
					</div>
					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
						<label for="">Primer nombre<b style="color:red">*</b></label> <input type="text" id="primerNombre" class="form-control"><br/>
					</div>

					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
						<label for="">Segundo nombre</label> <input type="text" id="segundoNombre" class="form-control"><br/>
					</div>
					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
						<label for="">Primer Apellido<b style="color:red">*</b></label> <input type="text" id="primerApellido" class="form-control">
					</div>

					<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
						<label for="">Segundo Apellido</label> <input type="text" id="segundoApellido" class="form-control">
					</div>
				</div>
				<br/>
				<div class="row">
